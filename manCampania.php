                ...
                <div class="card border-primary rounded-0">
                    <div class="card-header p-0">
                        <div class="bg-pink text-white text-center py-2">
                            ...
                            if(isset($_GET['id'])){
                                ?>
                                <h3><a href="#" onclick="divLogin()"><i class="fa fa-cubes"></i></a> Modificar Campa&ntilde;a</h3>
                                <?php
                            }else{
                                ?>
                                <h3><a href="#" onclick="divLogin()"><i class="fa fa-cubes"></i></a> Crear Campa&ntilde;a</h3>
                                <?php
                            }
                            ?>
                        </div>
...
//                                exit();
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                if(isset($_GET['id'])){
                                    ?>
                                    <input type="text" class="form-control" id="codigo" name="codigo" pattern="[A-Za-z0-9]{1,30}" title="solo se permiten caracteres de la A-Z a-z 0-9" placeholder="Codigo de Campa&ntilde;a" value="<?php echo $codigo;?>" required>
                                    <?php
                                }else{
                                    ?>
                                    <input type="text" class="form-control" id="codigo" name="codigo" pattern="[A-Za-z0-9]{1,30}" title="solo se permiten caracteres de la A-Z a-z 0-9" placeholder="Codigo de Campa&ntilde;a" required>
                                <?php }?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="text-center">
                            ...
                            <?php }?>
                            <button id="cancel" type="button" class="btn btn-pink btn-block rounded-0 py-2" name="cancel" onclick="location.href='manCampania.php'">Cancelar</button>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <table class="table table-condensed table-bordered table-hover">
                ...
                WHILE ($fila = $resultado->fetch_assoc()) {
                    ...
                    echo "<td><a href='manCampania.php?id=$fila[id]&mod=1'><span class='fa fa-edit'></span></a></td>";
