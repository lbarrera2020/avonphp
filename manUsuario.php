                ...
                <div class="card-body p-3" id="caja" <?php if(isset($_GET['mod'])){}else{echo 'hidden';}?>>                    <!--Body-->
                    ...
                    <div class="form-group">
                        <div class="input-group mb-2">
                            ...
                            if(isset($_GET['id'])){
                                ?>
                                <input type="text" class="form-control" id="usuario" name="usuario" pattern="[A-Za-z0-9-]{1,100}" maxlength="10" title="solo se permiten caracteres de la A-Za-z 0-9" placeholder="Ingrece el usuario" value="<?php echo $usuario;?>" required>
                                <?php
                            }else{
                                ?>
                                <input type="text" class="form-control" id="usuario" name="usuario" pattern="[A-Za-z0-9-]{1,100}" maxlength="10" title="solo se permiten caracteres de la A-Za-z 0-9" placeholder="Ingrece el usuario" required>
                            <?php }?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="text-center">
                        ...
                        <?php }?>
                        <button id="cancel" type="button" class="btn btn-pink btn-block rounded-0 py-2" name="cancel" onclick="location.href='manUsuario.php'">Cancelar</button>
                    </div>
                </div>
            </div>
        </form>
